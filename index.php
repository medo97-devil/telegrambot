<?php 
ob_start();
define('API_KEY','6580314272:AAEuA9-wOLoauMOsr17j3-c_Y_-tncbcqgs'); //Enter your bot's token here
$admin = "Medoahmad1997"; //Enter admin's numerical id
$zirmajmue = 4; //Number of refferals to become VIP
$botusername = "SyriaTalk"; //Bot's Username
$channelusername = "syriatalktele"; //Bot's channel's username
